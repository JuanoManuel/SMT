...
echo "<div class='row justify-content-between'>
								...
								<div class='col-auto'>
									<div class='form-group'>
										...
										<input type='text' value='" . $arrayRes["Afore"] . "' class='form-control' id='inputAfore' name='inputAfore'>
									</div>
								</div>
								<div class='col-auto'>
									<div class='form-group'>
										<label for='inputPasaporte'>Pasaporte</label>
										<input type='text' value='" . $arrayRes["Pasaporte"] . "' class='form-control' id='inputPasaporte' name='inputPasaporte'>
									</div>
								</div>
								<div class='col-auto'>
									<div class='form-group'>
										<label for='inputRFC'>RFC</label>
										<input required='' value='" . $arrayRes["RFC"] . "' type='text' class='form-control' id='inputRFC' name='inputRFC'>
								...
								<div class='col-auto'>
									<div class='form-group noSpinner'>
										...
										<input required='' type='number' value='" . $arrayRes["NSS"] . "' class='form-control' id='inputNSS' name='inputNSS'>
							...
							<div class='row'>";
								if($arrayRes["Documento_extranjero"]=="No"){
									...
									<div class='col-9'>
										<div class='form-group'>
											...
											<input type='text' disabled='' class='form-control' id='inputDocExtranjero' name='inputDocExtranjero'>
										</div>
									</div>";
								}else{
									echo "<div class='col-auto'>
									...
									<div class='col-9'>
										<div class='form-group'>
											<label for='inputDocExtranjero'>Documentos que le permiten trabajar en el pais</label>
											<input type='text' value='" . $arrayRes["Documento_extranjero"] . "' disabled='' class='form-control' id='inputDocExtranjero' name='inputDocExtranjero'>
										</div>
									</div>";
								}
							echo "</div>
							<div class='row'>
								...
								<div class='col-auto'>
									<div class='form-group noSpinner'>
										...
										<input type='number' value='" . $arrayRes["Licencia_Manejo"] . "' disabled='' class='form-control' id='inputLicencia' name='inputLicencia'>
									</div>
								</div>
							</div>
						<div class='row justify-content-md-center mt-2 mb-3'>
							...
							<div class='col col-lg-2'>
								<button type='button' class='btn bMT' id='guardar_doc' disabled>Guardar</button>
							</div>	
						</div>";
$resultado->free();
$link->close();