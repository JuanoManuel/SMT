...
$query = "SELECT idioma.idioma,empleado_idioma.nivel FROM empleado,idioma,empleado_idioma WHERE empleado.idempleado=empleado_idioma.fkempleado AND idioma.ididioma=empleado_idioma.fkidioma AND idEmpleado=$idEmpleado";
...
echo "<h2>Conocimientos generales</h2>
						...
						<div class='row'>
							<div class='borde-a col mx-3 mb-2'>
								...
								$resultado->free();
								$query = "SELECT software.idsoftware,software.nombre,empleado_software.nivel FROM empleado,software,empleado_software WHERE empleado.idempleado=empleado_software.fkempleado AND software.idsoftware=empleado_software.fksoftware AND idEmpleado=$idEmpleado";
									...
									echo "<div class='col-3'>
										<div class='form-group'>
											...
											switch ($arrayRes["nivel"]) {
												case 'basico':
													echo "<option value='noUso'>No lo uso</option>
												...
												case 'avanzado':
													...
													break;
												case 'noUso':
													echo "<option value='noUso' selected>No lo uso</option>
													<option value='basico' selected>Básico</option>
													<option value='intermedio'>Intermedio</option>
													<option value='avanzado'>Avanzado</option>";
													break;
						...
						<div class='row mt-4'>
							<div class='col text-center'>
								<button type='button' class='btn bMT' onclick='habilitar_conocimientos()' id='boton-hab-conocimientos'>Modificar</button>
							</div>
							<div class='col text-center'>
