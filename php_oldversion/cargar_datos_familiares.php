												...
												<div class='row'>
													<div class='col'>
														<div class='form-group'>
															<label>Nombre:</label>
															<input type='text' id='nombre_hijo_nuevo' name='' class='form-control'>
													...
													<div class='col'>
														<div class='form-group'>
															<label>Edad:</label>
															<input type='number' id='edad_hijo_nueva' name='' class='form-control'>
											...
											<div class='modal-body'>
												...
												<div class='row'>
													<div class='col-7'>
														<div class='form-group'>
															<label>Nombre:</label>
															<input type='text' id='nombre_pariente_nuevo' name='' class='form-control'>
													...
													<div class='col'>
														<div class='form-group'>
															...
															<input type='text' id='ocupacion_pariente_nuevo' name='' class='form-control'>
												...
												<div class='row'>
													<div class='col'>
														<div class='form-group'>
															...
															<input type='text' id='direccion_pariente_nuevo' name='' class='form-control'>
